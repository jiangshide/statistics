...
import com.jingos.statistics.net.HttpUtil;
import com.jingos.statistics.net.NetBroadcast;
...
//    private AMapLocationClientOption mAMapLocationClientOption;
    ...
    private String mUrl = "https://om-cn.jingos.com1/api/device-android/report";
...
//        okHttpClient.newCall(request).enqueue(this);
    ...
    public void onSuccess(String response) {
        LogUtil.e("---------responseCode~response", response);
